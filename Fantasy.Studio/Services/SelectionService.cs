...
namespace Fantasy.Studio.Services
{
    public  class SelectionService : ISelectionService, ISelectionServiceEx, IDisposable
    {
        ...
        public void SetSelectedComponents(ICollection components, SelectionTypes selectionType)
        {
            ...
            bool flag2 = (selectionType & SelectionTypes.Primary) == SelectionTypes.Primary;
            ...
            if (flag6)
            {
                flag = (Keyboard.Modifiers & (ModifierKeys.Control | ModifierKeys.Shift)) > ModifierKeys.None;
                flag3 |= Keyboard.Modifiers == ModifierKeys.Shift;
                if (flag || flag3)
                {
                    flag2 = false;
                }
