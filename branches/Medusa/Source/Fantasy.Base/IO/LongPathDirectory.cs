...
namespace Fantasy.IO {
    ...
    public static class LongPathDirectory {
        ...
        public static DiskspaceInfo GetDiskspaceInfo(string path)
        {
            ...
            {
                throw new ArgumentException(Resources.ArgumentCannotBeNullOrEmptyText, path);
            }
            ...
            if (NativeMethods.GetDiskFreeSpaceEx(path, out freeBytesAvailable, out totalNumberOfBytes, out totalNumberOfFreeBytes))
            {
