...
[assembly: EdmRelationshipAttribute("Model1", "Entity3Entity2", "Entity3", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(ConsoleTest.Entity3), "Entity2", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(ConsoleTest.Entity2))]
...
namespace ConsoleTest
{
    ...
    public partial class Model1Container : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<Entity3> Entity3Set
        {
            get
            {
                if ((_Entity3Set == null))
                {
                    _Entity3Set = base.CreateObjectSet<Entity3>("Entity3Set");
                }
                return _Entity3Set;
            }
        }
        private ObjectSet<Entity3> _Entity3Set;
        ...
        /// <summary>
        /// Deprecated Method for adding a new object to the Entity3Set EntitySet. Consider using the .Add method of the associated ObjectSet&lt;T&gt; property instead.
        /// </summary>
    ...
    public partial class Entity2 : Entity1
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Model1", "Entity3Entity2", "Entity3")]
        public Entity3 Entity3
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Entity3>("Model1.Entity3Entity2", "Entity3").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Entity3>("Model1.Entity3Entity2", "Entity3").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        [BrowsableAttribute(false)]
        [DataMemberAttribute()]
        public EntityReference<Entity3> Entity3Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Entity3>("Model1.Entity3Entity2", "Entity3");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<Entity3>("Model1.Entity3Entity2", "Entity3", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="Model1", Name="Entity3")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class Entity3 : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Model1", "Entity3Entity2", "Entity2")]
        public EntityCollection<Entity2> Entity2
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Entity2>("Model1.Entity3Entity2", "Entity2");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Entity2>("Model1.Entity3Entity2", "Entity2", value);
                }
            }
        }
