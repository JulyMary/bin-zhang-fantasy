...
{
    public class BusinessApplicationScript : NotifyPropertyChangedObject, IEntityScript, IWeakEventListener
    {

        public BusinessApplicationScript(BusinessApplicationData application)
        {
            this.Entity = application;
            this.IsReadOnly = application.IsSystem;
        ...
        {
            BusinessApplicationScript other = obj as BusinessApplicationScript;
