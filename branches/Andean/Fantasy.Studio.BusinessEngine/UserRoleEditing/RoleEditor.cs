...
namespace Fantasy.Studio.BusinessEngine.UserRoleEditing
{
    public class RoleEditor : EntityEditingViewContent
    {
        ...
        {
            get { return this.Data != null ? ((BusinessUserData)this.Data).Name : string.Empty; }
        }
        ...
        public override ImageSource Icon
        {
            get
            {
                if (_icon == null)
                {
                    _icon = new BitmapImage(new Uri("/Fantasy.Studio.BusinessEngine;component/images/role.png", UriKind.Relative));
                }
                return _icon;
            }
        }
