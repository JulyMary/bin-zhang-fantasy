...
public enum CSIDL
{
	...
	private static java.util.HashMap<Integer, CSIDL> mappings;
	private synchronized static java.util.HashMap<Integer, CSIDL> getMappings()
	{
		if (mappings == null)
		{
			mappings = new java.util.HashMap<Integer, CSIDL>();
		}
		return mappings;
	}
	...
	{
		intValue = value;
		CSIDL.getMappings().put(value, this);
	}
	...
	public static CSIDL forValue(int value)
	{
