...
namespace Fantasy.Windows.Forms
{
    using System;
    ...
    using Fantasy.Windows.Forms.Win32;
    ...
    public class FolderBrowserDialogEx : System.Windows.Forms.CommonDialog
    {
        ...
        private void BecomePrinterBrowser()
        {
            ...
            ShellApi.SHGetSpecialFolderLocation(IntPtr.Zero, CSIDL.PRINTERS, ref this._rootFolderLocation);
        ...
        private void BecomeComputerBrowser()
        {
            ...
            ShellApi.SHGetSpecialFolderLocation(IntPtr.Zero, CSIDL.NETWORK, ref this._rootFolderLocation);
            ShowNewFolderButton = false;
            ShowEditBox = false;
        }
        ...
        {
            if (this.Extensions != null && this.Extensions.Length > 0 && iunknown != IntPtr.Zero)
            {
                IntPtr iFolderFilterSite;

                Guid iid_IFolderFilterSite = typeof(IFolderFilterSite).GUID;

                Marshal.QueryInterface(iunknown, ref iid_IFolderFilterSite, out iFolderFilterSite);
                ...
                filter.ValidExtension = this.Extensions;
        ...
        protected override bool RunDialog(IntPtr hWndOwner)
        {
            ...
            {
                ShellApi.SHGetSpecialFolderLocation(hWndOwner, (int)this._rootFolder, ref _rootFolderLocation);
                if (_rootFolderLocation == IntPtr.Zero)
                {
