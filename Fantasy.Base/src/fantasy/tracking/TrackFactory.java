...
public class TrackFactory
{
	...
	public final ITrackProvider CreateProvider(UUID id, String name, String category, java.util.Map<String, Object> values)
	{
	...
	public final ITrackListener CreateTrackListener(UUID id)
	{
