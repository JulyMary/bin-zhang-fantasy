    ...
    public class ContextMenuItemAdv : HeaderedItemsControl // , ICommandSource // ICommandSource not defined by Silverlight 4
    {
        ...
        internal void CheckForBoundaryCollision()
        {
            if (this.PART_Popup != null)
            {
                ...
                //    {
                //        if (this.Items[i] is ContextMenuItemAdv)
                //            height = height + (this.Items[i] as ContextMenuItemAdv).ActualHeight;
                //    }
                //}
            ...
            //{
            //    gt = this.ParentMenuItemAdv.subMenuItemsPopup.TransformToVisual(Application.Current.RootVisual as UIElement);
            //    offset = gt.Transform(new Point(0, 0));

            //    this.ParentMenuItemAdv.subMenuItemsPopupTop = offset.Y + this.ParentMenuItemAdv.subMenuItemsPopup.VerticalOffset;
            //    this.ParentMenuItemAdv.subMenuItemsPopupLeft = offset.X + this.ParentMenuItemAdv.subMenuItemsPopup.HorizontalOffset;

            //    this.ParentMenuItemAdv.CalculateHeightOfSubMenuItemsPopup();
            //    this.ParentMenuItemAdv.CalculateWidthOfSubMenuItemsPopup();
            //    if (this.ParentMenuItemAdv.ParentMenuAdv != null)
            //    {
            //        if (this.ParentMenuItemAdv.ParentMenuAdv.Orientation == Orientation.Horizontal)
            //        {
            //            if ((this.ParentMenuItemAdv.subMenuItemsPopupTop + this.ParentMenuItemAdv.heightOfSubMenuItemsPopup) > Application.Current.Host.Content.ActualHeight)
            //            {
            //                this.ParentMenuItemAdv.subMenuItemsPopup.VerticalOffset = -this.ParentMenuItemAdv.heightOfSubMenuItemsPopup;
            //            }

            //            if ((this.ParentMenuItemAdv.subMenuItemsPopupLeft + this.ParentMenuItemAdv.widthOfSubMenuItemsPopup) > Application.Current.Host.Content.ActualWidth)
            //            {
            //                this.ParentMenuItemAdv.subMenuItemsPopup.HorizontalOffset = this.ParentMenuItemAdv.ActualWidth - this.ParentMenuItemAdv.widthOfSubMenuItemsPopup;
            //            }
            //        }
            //        else
            //        {
            //            if ((this.ParentMenuItemAdv.subMenuItemsPopupLeft + this.ParentMenuItemAdv.widthOfSubMenuItemsPopup) > Application.Current.Host.Content.ActualWidth)
            //            {
            //                this.ParentMenuItemAdv.subMenuItemsPopup.HorizontalOffset = -this.ParentMenuItemAdv.widthOfSubMenuItemsPopup;
            //            }

            //            if ((this.ParentMenuItemAdv.subMenuItemsPopupTop + this.ParentMenuItemAdv.heightOfSubMenuItemsPopup) > Application.Current.Host.Content.ActualHeight)
            //            {
            //                this.ParentMenuItemAdv.subMenuItemsPopup.VerticalOffset = -((this.ParentMenuItemAdv.subMenuItemsPopupTop + this.ParentMenuItemAdv.heightOfSubMenuItemsPopup) - Application.Current.Host.Content.ActualHeight);
            //            }
            //        }
            //    }
            //    else
