...
public class StandaloneJobDispatcherService extends AbstractService implements IJobDispatcher
{
	...
	{
		this._queue = (IJobQueue)this.Site.GetService(IJobQueue.class);
...
//C# TO JAVA CONVERTER TODO TASK: Java has no equivalent to C#-style event wireups:
		...
		_resourceManager = this.Site.<IResourceManager>GetService();
...
//C# TO JAVA CONVERTER TODO TASK: Java has no equivalent to C#-style event wireups:
	...
	{
		IJobController controller = (IJobController)this.Site.GetService(IJobController.class);
