...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	public final void Refresh()
	{
		...
		{
			for (java.util.Map.Entry<Guid, WeakReference> pair : new java.util.ArrayList<java.util.Map.Entry<Guid, WeakReference>>(this._remoteTracks))
			{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	private java.util.HashMap<Guid, WeakReference> _remoteTracks = new java.util.HashMap<Guid, WeakReference>();

	public final RemoteTrack FindTrack(Guid id)
	{
		RemoteTrack rs = null;
		synchronized (_syncroot)
		{
	...
	public final boolean CreateTrack(Guid id, String name, String category, java.util.Map<String, Object> values, boolean reconnect, RefObject<RemoteTrack> track)
	{
